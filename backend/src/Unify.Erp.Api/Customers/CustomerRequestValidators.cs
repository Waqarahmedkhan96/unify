...
public static class CustomerRequestValidators
{
    public static ValidationResult Validate(this CreateCustomerRequest request)
    {
        ...
        AddRequired(result, nameof(request.CustomerNumber), request.CustomerNumber, 2, 32);
        ...
        {
            result.Add(nameof(request.CreditLimit), "Value cannot be negative.");
        }
